...
DATAPLANE_SHA_URL="https://github.com/haproxytech/dataplaneapi/releases/download/$DATAPLANE_MINOR/dataplaneapi_checksum.txt"
DATAPLANE_SHA256=$(curl -sfSL "$DATAPLANE_SHA_URL" | awk '{print $1}')
